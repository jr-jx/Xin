...
```bash
node .claude/skills/dependency-update/scripts/dependency_plan.mjs
```

检查指定包：

```bash
node .claude/skills/dependency-update/scripts/dependency_plan.mjs nuxt vue @nuxt/content
```
