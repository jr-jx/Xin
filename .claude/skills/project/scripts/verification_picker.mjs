...
function classify(file) {
	if (/^\.claude\/skills\/project\//.test(file))
		return { type: 'skill', command: 'node .claude/skills/project/scripts/skill_doctor.mjs', reason: 'Project skill metadata, references, or scripts changed' }
